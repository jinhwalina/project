...
public class mypageDto {
	...
	public String toString() {
		return "mypageDto [pname=" + pname + ", pgender=" + pgender + ", pino=" + pino + ", psur=" + psur + ", pcau="
				+ pcau + ", ptype=" + ptype + ", pet_user_mail=" + pet_user_mail + ", pet_inn_num=" + pet_inn_num
				+ ", petnum=" + petnum + ", inn_num=" + inn_num + ", inn_total_price=" + inn_total_price
